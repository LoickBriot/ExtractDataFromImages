...
public class ConvertUtil {
     ...
     */
    public BufferedImage convert1(BufferedImage src) {
     ...
     */
    public BufferedImage convert4(BufferedImage src) {
     ...
     */
    public BufferedImage convert4(BufferedImage src, int[] cmap) {
     ...
     */
    public BufferedImage convert24(BufferedImage src) {
        BufferedImage dest = new BufferedImage(src.getWidth(), src.getHeight(),
     ...
     */
    public BufferedImage convert32(BufferedImage src) {
        BufferedImage dest = new BufferedImage(src.getWidth(), src.getHeight(),
